...
func Main() {
	...
	deleteBcpCmd.Flag("ignore-pitr", "Ignore PITR base snapshot restriction").BoolVar(&deleteBcp.ignorePITR)
	...
	deletePitrCmd.Flag("ignore-pitr", "Ignore PITR base snapshot restriction").BoolVar(&deletePitr.ignorePITR)
