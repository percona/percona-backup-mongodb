...
.. glossary::
  ...
  Server-side encryption
     Server-side encryption is the encryption of data on the remote storage. The data is encrypted when it is written to S3 bucket and decrypted when you access the data. 