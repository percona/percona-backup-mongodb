...
.. hlist::
   ...
   - Backup and restore for both classic non-sharded replica sets and sharded clusters using 'logical' style method. Physical-style (a.k.a. 'hot') backup and restore not supported
