...
Use the |pbm-delete-backup| command to delete a specified backup.
...
You can delete the set of backups that precede the specified backup by
passing  the ``--older-than`` flag to the |pbm-delete-backup|
...
Alternatiely, you can delete all backups that were created before the specified
timestamp. Specify the timestamp in the ISO 8601 format as an argument
