...
func (l *Logger) Output(ctx context.Context, e *Entry) error {
	var rerr error
...
func fetch(ctx context.Context, m connect.MetaClient, r *LogRequest, limit int64, exactSeverity bool) (*Entries, error) {
