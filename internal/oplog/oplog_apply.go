	...
	for {
		...
		*/
		...
		if err != nil {
			...
			continue
			//TODO: What we really should do if we cannot apply one op?
			// Sometimes, for example is a collection already exists, re-applying the op will
			// return an error. Should we stop?
			//return err
		}
