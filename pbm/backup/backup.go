...
func (b *Backup) Run(ctx context.Context, bcp pbm.BackupCmd, opid pbm.OPID, l *plog.Event) (err error) {
	...
	case pbm.LogicalBackup:
		return b.runLogical(ctx, bcp, opid, l)
	case pbm.PhysicalBackup:
		return b.runPhysical(ctx, bcp, opid, l)
	default:
...
// run logical backup.
// TODO: describe flow
func (b *Backup) runLogical(ctx context.Context, bcp pbm.BackupCmd, opid pbm.OPID, l *plog.Event) (err error) {
