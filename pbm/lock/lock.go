...
type LockHeader struct {
	...
	Epoch *bsonv2.Timestamp `bson:"epoch,omitempty" json:"epoch,omitempty"`
}

type LockData struct {
	LockHeader `bson:",inline"`
	Heartbeat  bsonv2.Timestamp `bson:"hb"` // separated in order the lock can be searchable by the header
}
