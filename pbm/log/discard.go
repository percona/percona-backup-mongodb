...
func (l discardLoggerImpl) NewEvent(typ, name, opid string, epoch bson.Timestamp) LogEvent {
...
func (discardLoggerImpl) Debug(event, obj, opid string, epoch bson.Timestamp, msg string, args ...any) {
}

func (discardLoggerImpl) Info(event, obj, opid string, epoch bson.Timestamp, msg string, args ...any) {
}

func (discardLoggerImpl) Warning(event, obj, opid string, epoch bson.Timestamp, msg string, args ...any) {
}

func (discardLoggerImpl) Error(event, obj, opid string, epoch bson.Timestamp, msg string, args ...any) {
}

func (discardLoggerImpl) Fatal(event, obj, opid string, epoch bson.Timestamp, msg string, args ...any) {
}
