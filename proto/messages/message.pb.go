...
func (ErrorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{0}
}
...
func (BackupType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{1}
}
...
func (DestinationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{2}
}
...
func (CompressionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{3}
}
...
func (Cypher) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{4}
}
...
func (NodeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{5}
}
...
func (ServerMessage_MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{0, 0}
}
...
func (ClientMessage_MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{1, 0}
}
...
type ClientMessage_BackupSource struct {
	BackupSource string `protobuf:"bytes,8,opt,name=BackupSource,proto3,oneof"`
}
...
func (*ClientMessage_BackupSource) isClientMessage_Payload() {}
...
func (m *ClientMessage) GetBackupSource() string {
	if x, ok := m.GetPayload().(*ClientMessage_BackupSource); ok {
...
func (*ClientMessage) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ClientMessage_OneofMarshaler, _ClientMessage_OneofUnmarshaler, _ClientMessage_OneofSizer, []interface{}{
		...
		(*ClientMessage_BackupSource)(nil),
	}
}
...
func _ClientMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ClientMessage_BackupSource:
		b.EncodeVarint(8<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.BackupSource)
	case nil:
	default:
...
func _ClientMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 7: // Payload.StatusMsg
		...
		return true, err
	case 8: // Payload.BackupSource
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Payload = &ClientMessage_BackupSource{x}
		return true, err
	default:
		return false, nil
	}
...
func _ClientMessage_OneofSizer(msg proto.Message) (n int) {
	...
	case *ClientMessage_BackupSource:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.BackupSource)))
		n += len(x.BackupSource)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
func (*StopBackup) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{6}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{7}
}
...
func (*BackupFinished) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_64124c609e5a68f8, []int{8}
}
...
func init() { proto.RegisterFile("message.proto", fileDescriptor_message_64124c609e5a68f8) }

var fileDescriptor_message_64124c609e5a68f8 = []byte{
	// 1204 bytes of a gzipped FileDescriptorProto
	,
}
